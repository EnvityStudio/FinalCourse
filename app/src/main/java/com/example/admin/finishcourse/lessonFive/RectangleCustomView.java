...
import com.example.admin.finishcourse.lessonFour.GameLoopThread;
import com.example.admin.finishcourse.lessonFour.Rectangle;
...
public class RectangleCustomView extends View {
    ...
    public RectangleCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init() {
        ...
        soundTing = soundPool.load(context, R.raw.smb_coin, 1);
    }
